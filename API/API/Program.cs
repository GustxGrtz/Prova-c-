...
app.MapPut("/tarefas/alterar/{id}", ([FromServices] AppDataContext ctx, [FromBody] Tarefa tarefaAlterado, [FromRoute] string id) =>
{
    ...
    tarefa.CriadoEm = tarefaAlterado.CriadoEm;
    tarefa.Categoria = tarefaAlterado.Categoria;
    ...
    // if (tarefaAlterado.Categoria == Results.AcceptedAtRoute){
...
app.MapGet("/tarefas/naoconcluidas", ([FromServices] AppDataContext ctx) =>
{
    ...
    return Results.NotFound("Fora do range");
});
